...
export function VisionScene() {
  ...
  return (
    <section id="vision" ref={ref} className="relative h-[160vh] bg-canvas">
      <div className="sticky top-0 flex h-screen items-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-12 px-6 md:pl-32 lg:grid-cols-2 lg:pl-48">
          ...
          <motion.div style={{ opacity, y }}>
            <h2 className="font-display text-5xl font-light leading-[0.95] tracking-tight text-ink md:text-6xl lg:text-7xl">
              First, we understand
              <br />
